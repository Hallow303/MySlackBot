...
A Slack bot with a variety of fun and useful commands.

<img src="./img/koi.png" width="350">
...
**[Test Koizinho on Slack](https://hackclub.enterprise.slack.com/archives/C0BJ6DKPT36)**
...
| Random Duck API | https://random-d.uk/       |
| RandomFox API   | https://randomfox.ca/      |

> [!NOTE]
> Credits for the sounds used can be found in [SoundCredits.md](SoundCredits.md).
